...
**Sur la slide**
> **51 tests · 86 % de couverture · `pytest -m "not local_service"`**
>
...
| **C12** | **51 tests, 86 %**, dont robustesse ; non-régression vérifiée dans les deux sens | `pytest` |
...
> latence et d'erreurs avec des seuils ; cinquante et un tests dont la robustesse du modèle ; et
