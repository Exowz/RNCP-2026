...
| Indicateur | Valeur |
|---|---|
| Tests automatisés | **49** (48 hors service local), couverture **86 %** |
...
| **C12** | 🟢 | **49 tests**, couverture **86 %** : formats, nettoyage, Spark, PostgreSQL, entraînement, rechargement d'artefact, endpoints, **robustesse du modèle**, accessibilité. | `pytest -m "not local_service"` |
